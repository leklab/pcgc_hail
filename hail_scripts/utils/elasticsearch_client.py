...
from utils.elasticsearch_client_shared import ElasticsearchClient as BaseElasticsearchClient

from utils.elasticsearch_utils_shared import (
    ELASTICSEARCH_INDEX,
...
from utils.elasticsearch_utils import elasticsearch_schema_for_table
